module.exports = {
  root: true,
  plugins: ["lodash", "unused-imports", "cypress", "chai-friendly", "react-hooks", "no-only-tests"],
  settings: {
    "import/parsers": {
  ...
  overrides: [{
    ...
    rules: {
      ...
      "import/order": ["warn", {
        ...
        groups: ["builtin", "external", "parent", ["sibling", "index"], "object", "unknown"],
    ...
    files: ["src/**/*.test.*"],
    extends: ["next", "next/core-web-vitals", "plugin:jest/recommended", "plugin:jest/style", "prettier"],
    rules: {
    ...
    extends: ["next", "plugin:cypress/recommended", "plugin:chai-friendly/recommended", "prettier"],
    env: {
